...
function createPageLinksDiv(pageDiv) { //creates the container div that holds buttons
  let pageLinksDiv = document.createElement('div'); //creates div element and stores it in variable
  pageLinksDiv.className = 'pagination'; //gives class name to created div element
  pageDiv.appendChild(pageLinksDiv); //appends new div element to the main page div
}
...
function appendPageLinks(list) {
  ...
  createPageLinksDiv(page); // creates a page link section
  // "for" every page
  // for (i=0; i<lis.length; i++) {
  //   createPageLinks(lis[i]);
  // }
